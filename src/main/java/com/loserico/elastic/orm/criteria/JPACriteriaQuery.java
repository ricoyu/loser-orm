package com.loserico.elastic.orm.criteria;
...
import com.loserico.elastic.orm.exception.JPACriteriaQueryException;
...
public class JPACriteriaQuery<T> implements Serializable {
	...
	public JPACriteriaQuery<T> addPredicate(com.loserico.elastic.orm.predicate.Predicate predicate) {
		this.predicates.add(predicate.toPredicate(criteriaBuilder, root));
		return this;
	}

	public JPACriteriaQuery<T> addPredicates(com.loserico.elastic.orm.predicate.Predicate... predicates) {
	...
	public JPACriteriaQuery<T> addPredicates(List<com.loserico.elastic.orm.predicate.Predicate> predicates) {
		if (predicates != null && predicates.size() > 0) {
			for (com.loserico.elastic.orm.predicate.Predicate predicate : predicates) {
